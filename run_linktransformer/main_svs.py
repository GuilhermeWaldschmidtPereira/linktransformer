...
from linktransformer.infer_main import merge_knn_svs  # noqa: E402
...
def assert_embeddings_exist(modelo: str) -> None:
    ...
    if missing_paths:
        ...
        raise FileNotFoundError(
            "Embeddings pre-computados não encontrados para o SVS. "
    ...
    try:
        ...
        for modelo in MODELOS_A_UTILIZAR:
            ...
            for k in ks:
                ...
                merge_knn_svs(k, df1, df2, suffixes, modelo)
    except Exception as exc:
        print(f">>> ERRO em main_svs.py: {type(exc).__name__}: {exc}", flush=True)
